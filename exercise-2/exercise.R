...
sentence <- tolower("I like to eat apples and bananas every saturday night.")
...
letters_in_sentence <- strsplit(sentence, "")

# Extract the vector of letters from the resulting list
letters <- letters_in_sentence[[1]]
...
count_occurences <- function(letter, all_letters){
...
freq <- as.list(sapply(unique_letters, count_occurences, letters))
